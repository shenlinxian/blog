class PassagesController < ApplicationController
  ...
  def create
    ...
    #     # format.json { render action: 'show', status: :created, location: @passage }
    #   else
  ...
  private
    ...
    def passage_params
      params.require(:passage).permit(:user_id, :title, :content, :catagory, :read_number, :thumber_up_number)
    end
end
